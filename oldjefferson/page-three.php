...
<body>
	<div class="titleDiv">
		<div class="container">
			<div class="title">Old Jefferson Historical District</div>
			<div class="button">
	...
	$sql = "SELECT * FROM buildingData WHERE Ranking = '$Ranking' and District = 'Old Jefferson' ORDER BY SiteNumber";

	if ($Ranking == "All") {
		$sql = "SELECT * FROM buildingData WHERE District = 'Old Jefferson' ORDER BY SiteNumber";
	}
