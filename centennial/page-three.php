...
<body>
	<div class="titleDiv">
		<div class="container">
			<div class="title">Centennial Historic District</div>
			<div class="button">
...
/////
	...
	$sql = "SELECT * FROM buildingData WHERE Ranking = '$Ranking' and District = 'Centennial' ORDER BY SiteNumber";

	if ($Ranking == "All") {
		$sql = "SELECT * FROM buildingData WHERE District = 'Centennial' ORDER BY SiteNumber";
	}
