...
<body>
	<div class="titleDiv">
		<div class="container">
			<div class="title">Park Mary Historical District</div>
			<div class="button">
	...
	$sql = "SELECT * FROM buildingData WHERE Ranking = '$Ranking' and District = 'Park Mary' ORDER BY SiteNumber";

	if ($Ranking == "All") {
		$sql = "SELECT * FROM buildingData WHERE District = 'Park Mary' ORDER BY SiteNumber";
	}
