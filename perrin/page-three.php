...
<body>
	<div class="titleDiv">
		<div class="container">
			<div class="title">Perin Historical District</div>
			<div class="button">
	...
	$sql = "SELECT * FROM buildingData WHERE Ranking = '$Ranking' and District = 'Perrin' ORDER BY SiteNumber";

	if ($Ranking == "All") {
		$sql = "SELECT * FROM buildingData WHERE District = 'Perrin' ORDER BY SiteNumber";
	}
