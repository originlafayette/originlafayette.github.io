...
<body>
	...
	<form method="post" action="register.php" style="background-color: white; box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.1); border-radius: 2px 2px 15px 10px;">
		...
		<p style="font-size: 17px">
			Already a member? <a style="font-size: 17px; color: #5F9EA0" href="login.php">Sign in</a>
		</p>
	</form>
