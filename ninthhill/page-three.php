...
<body>
	<div class="titleDiv">
		<div class="container">
			<div class="title">Ninth St. Hill Historical District</div>
			<div class="button">
    ...
    <!-- Table Content -->
	<div class="container">
		<h3 class="rank_title"> <?php $Ranking = $_POST['ranking'];
		echo $Ranking?> Building Data</h3>
		<table class="table">
			<thead>
				<tr>
	...
	$sql = "SELECT * FROM buildingData WHERE Ranking = '$Ranking' and District = 'Ninth St. Hill' ORDER BY SiteNumber";

	if ($Ranking == "All") {
		$sql = "SELECT * FROM buildingData WHERE District = 'Ninth St. Hill' ORDER BY SiteNumber";
	}
