...
<body>
	<div class="titleDiv">
		<div class="container">
			<div class="title">St. Mary's Historical District</div>
			<div class="button">
...
/////
	...
	$sql = "SELECT * FROM buildingData WHERE Ranking = '$Ranking' and District = 'St. Marys' ORDER BY SiteNumber";

	if ($Ranking == "All") {
		$sql = "SELECT * FROM buildingData WHERE District = 'St. Marys' ORDER BY SiteNumber";
	}
