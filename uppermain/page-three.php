...
<body>
	...
	<div class="container">
		...
		<table class="table">
			...
			$sql = "SELECT * FROM buildingData WHERE Ranking = '$Ranking' and District = 'Upper Main' ORDER BY SiteNumber";

			if ($Ranking == "All") {
				$sql = "SELECT * FROM buildingData WHERE District = 'Upper Main' ORDER BY SiteNumber";
			}
