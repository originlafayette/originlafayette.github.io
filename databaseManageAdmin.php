...
<body>
	<div class="titleDiv">
		<div class="container">
			<div class="title">Admin Manage Database</div>
			<div class="button">
    ...
    <!-- Table Content -->
	<div class="container">
		<h3 class="rank_title"> <?php $District = $_POST['district'];
		echo $District?> Building Data</h3>
        <table class="table">
            <thead>
                <tr>
	...
	if (mysqli_num_rows($results)>0) {
		while($row=mysqli_fetch_array($results)) {
			echo "<tr image_data='images/bldgImages/" . $row['Images'] . "'>
					...
					<td> <div class='row_data' edit_type='click' col_name='Name'>". $row[3] . "</div></td>
					<td> <div class='row_data' edit_type='click' col_name='StreetAddress'>". $row[4] . "</div></td>
					<td> <div class='row_data' edit_type='click' col_name='Location'>". $row[5] . "</div></td>
					<td> <div class='row_data' edit_type='click' col_name='Ranking'>". $row[6] . "</div></td>
					<td> <div class='row_data' edit_type='click' col_name='Architecture'>". $row[7] . "</div></td>
					<td> <div class='row_data' edit_type='click' col_name='Year'>". $row[8] . "</div></td>
					<td> <button type='button' class='btn btn-link' data-toggle='modal' id='button-view' data-target='.bd-example-modal-lg'> View </button></td>
