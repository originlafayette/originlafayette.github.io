...
/////
	...
	$sql = "SELECT * FROM buildingData WHERE Ranking = '$Ranking' and District = 'Highland Park' ORDER BY SiteNumber";

	if ($Ranking == "All") {
		$sql = "SELECT * FROM buildingData WHERE District = 'Highland Park' ORDER BY SiteNumber";
	}
