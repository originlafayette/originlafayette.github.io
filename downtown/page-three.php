...
<body>
	...
	$sql = "SELECT * FROM buildingData WHERE Ranking = '$Ranking' and District = 'Downtown' ORDER BY SiteNumber";

	if ($Ranking == "All") {
		$sql = "SELECT * FROM buildingData WHERE District = 'Downtown' ORDER BY SiteNumber";
	}
